...
function Navbar() {
    ...
    return (
        <>
            <nav
                className={`fixed z-10 flex w-full p-6 text-sm font-light text-neutral-100 duration-300 hover:bg-white hover:text-neutral-600 ${isModalOpen ? 'pointer-events-none' : ''
                    }`}
            >
                {/* Left navbar */}
