    ...
    <>
      ...
      >
        <ul className="hidden uppercase md:flex lg:flex">
          <li>
            <Link to="/category" onClick={() => setShowSearchBar(false)}>
              shop
            </Link>
          </li>
          <li className="pl-8">
            <Link to="/kits" onClick={() => setShowSearchBar(false)}>
              kits
            </Link>
          </li>
        </ul>
        ...
        <ul className="flex uppercase md:hidden lg:hidden">
          <li>
            <img
              ...
              className={`mx-auto h-4 duration-300 hover:cursor-pointer ${
                changeNavbarColor ||
                window.location.pathname != '/' ||
                hoverNavbar
                  ? ''
        ...
        {showSearchBar && (
          <>
            <div className="absolute top-[68px] left-0 z-50 h-screen w-screen bg-black p-6 text-neutral-600 opacity-60"></div>
