  ...
  return (
    <>
     <div className="relative">
        <video className= "right-0 bottom-0 min-w-full min-h-full" autoPlay loop muted src="https://cdn.shopify.com/videos/c/o/v/a1e944e243cd4e06b50e5eebd96d0d2f.mp4"></video>
        <div className="absolute uppercase bottom-3 md:bottom-40 lg:bottom-48 sm:mx-0 md:mx-20 lg:mx-20 text-center md:text-left lg:text-left w-full md:w-max lg:w-max">
