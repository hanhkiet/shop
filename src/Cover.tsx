function Cover() {
  ...
  return (
    <>
      ...
      <div className="absolute uppercase bottom-2 md:bottom-20 lg:bottom-20 sm:mx-0 md:mx-20 lg:mx-20 text-center md:text-left lg:text-left w-full md:w-max lg:w-max">
